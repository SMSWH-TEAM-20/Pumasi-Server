...
public class MemberServiceTest {
    ...
    void memberServiceTest() {
        Member member = new Member("no.7", "memberA", "image".getBytes(), "1234", "email", "010");
        //회원 가입
    ...
    public void findAll(){
        //전체회원 조회
        Member member1 = new Member("no.1", "memberA", "image".getBytes(), "1", "email1", "112");
        memberService.join(member1);
        Member member2 = new Member("no.2", "memberB", "image".getBytes(),  "2", "email2", "119");
    ...
    public void findRegistrationItems(){
        ...
        Registration registration1 = new Registration("물건", "image".getBytes(),"입니다",  "no.1", "가전", 1L);
        registrationService.register(registration1);
        memberService.findRegistrationItems(member1);

        Registration registration2 = new Registration("사과", "image".getBytes(),"이다", "no.2", "음식", 2L);
